\chapter*{Abstract}
The core objective of this thesis is to advance the geographic allocation of charging capacities for aggregated battery-electric road vehicle fleets at large geographic scales, i.e., beyond the regional scale, up to the international scope, by analyzing and identifying important drivers relevant to the geographic allocation. These drivers encompass fleet-type specific technical parameters of the battery, i.e., charging power, battery size, consumer-type specific behavioral aspects, and, impact of regionally differing charging costs, driven by different electricity prices and grid charges.

The four underlying journal publications address literature gaps across different fleet types, i.e., passenger car and commercial fleets, and for, both, regional and interregional transport. The methodologies are based on two optimization models and one simulation model. A common core features is that origin-destination data, which expresses the amount of flows of passengers, vehicles or freight volumes are used as a basis, or data derived from this, f.e., traffic counts, are used. This consistently allows to consider the mobility of the consumers, i.e, the vehicles, and through this, the spatially flexible allocation of the charging demand within its route.

In the planning of fast-charging infrastructure for the Austrian highway network for 2030, it is found that the development of the driving range has a limited impact on the required number of charging sites. An analysis for the public charger infrastructure needs for passenger car owners yields the importance of considering the spatial density of public charging sites. For international truck transport, the impact of spatially differing charging costs, through the geographically differing elecricity prices and network charges, on future charging loads is quantified. At last, the relevant of the consideration of transit truck flow through countries to the locally aggregated load profiles of commercial fleets is made evident.   

The main conclusions include \dots 

These indicate that future work must consider \dots 
