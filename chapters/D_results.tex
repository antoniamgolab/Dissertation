...
\subsection{Border region analysis: Germany--Austria--Italy}
    ...
    At an electricity price premium of +0.04~\euro/kWh, charging demand in Austria drops by 97\% (from 120~GWh to 3~GWh in 2032), with demand redirected primarily to Italy. AT33 (Tyrol) --- the primary transit node for DE--IT freight --- sees a 99.9\% reduction in charged energy. This reallocation effect saturates at low premium levels: even +0.01~\euro/kWh, which merely narrows the AT--DE price gap without reversing it, reduces Austrian charging by approximately 10\%.
