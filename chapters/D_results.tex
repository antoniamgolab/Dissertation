...
This chapter presents the case studies and results of the four contributions underlying this thesis. Each section corresponds to one contribution and draws on the respective publication: \citet{en15062147} (2022) for Contribution~1 (Section~\ref{sec:rq1_results}), \citet{GOLAB2026PublicCharger} (2026) for Contribution~2 (Section~\ref{sec:rq2_results}), \citet{GOLAB2026SpatialTruck} (2026) for Contribution~3 (Section~\ref{sec:rq3_results}), and \citet{GOLAB2025134385} (2025) for Contribution~4 (Section~\ref{sec:rq4_results}).
...
The following case study and results are taken from the journal publication by \citet{en15062147} (2022).
...
The following case study and results are taken from the journal publication by \citet{GOLAB2026PublicCharger} (2026). The extended nomenclature and mathematical formulation are provided in Appendices~\ref{app:rq2_nomenclature} and~\ref{app:rq2_math}, respectively. Computational details are provided in Appendix~\ref{app:rq2_computational}.
...
The following case study and results are taken from the journal publication by \citet{GOLAB2026SpatialTruck} (2026).
...
\subsection{Case study: Scandinavian-Mediterranean corridor}
    ...
    \subsubsection{Spatial reallocation mechanisms}
        ...
        \begin{table}[H]
        \centering
        \caption{Spatial reallocation mechanisms and their effects on charging load distribution.}
...
The following case study and results are taken from the journal publication by \citet{GOLAB2025134385} (2025).
...
\begin{table}[H]
\centering
\caption{Annual charging demand of three commercial fleet types under different electrification rate assumptions for Austria in 2040. HDV demand is further disaggregated by physical charging location.}
