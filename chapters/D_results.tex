...
\begin{table}[htbp]
\centering
\caption{Classification of SNF charging demand in Austria by traffic type}
...
\begin{tablenotes}
\small
\item Note: Based on ETIS+ 2030 transport flow projections. AT tkm refers to ton-kilometers traveled within Austria. Daily demand represents electricity required for charging within Austria.
\end{tablenotes}
\end{table}

% Alternative: Yearly demand table
\begin{table}[htbp]
\centering
\caption{Annual SNF charging demand in Austria by traffic type (100\% electrification)}
...
\begin{tablenotes}
\small
\item Note: Annual values calculated with 261 workdays and 95\% charging efficiency. Depot day charging is zero for all categories due to short Austrian route segments.
\end{tablenotes}
\end{table}

% Compact single table version
\begin{table}[htbp]
\centering
\caption{SNF charging demand in Austria by traffic type}
...
\begin{figure}[H]
            ...
            \caption{Charging demand profiles of the commercial BEV fleet by node.}
            \label{fig:dispatch_time}
        \end{figure}
...
\begin{figure}[H]
            ...
            \caption{Charging demand by fleet type of three selected locations in Austria.}
            \label{fig:dispatch_time}
        \end{figure}
