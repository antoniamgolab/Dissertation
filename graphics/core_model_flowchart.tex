...
\node[inputbox, below=of input3] (input4) {
    \textbf{Parameters on charging\\infrastructure expansion}\\[2pt]
    Differentiated by fuel \& charging power | Maximum possible speed of build-up
};

\node[inputbox, below=of input4] (input5) {
    Fuel prices | technology costs | charging infrastructure costs | route-related / location-specific costs\ldots
};
...
\node[modelbox, right=2.2cm of input3, minimum height=10.5cm] (model) {
    ...
    \begin{itemize}
        ...
        \item Sizing of charging infrastructure
        \item Spatially flexible charging activity
    \end{itemize}
};
